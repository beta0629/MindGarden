...
@Slf4j
@RestController
@RequestMapping({"/api/v1/test/payment", "/api/test/payment"}) // v1 경로 추가, 레거시 경로 유지
...
public class PaymentTestController extends BaseApiController {
     ...
     */
    @PostMapping("/create")
    public ResponseEntity<ApiResponse<com.coresolution.consultation.dto.PaymentResponse>> createTestPayment(
