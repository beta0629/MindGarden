-- ProcessIntegratedSalaryCalculation: salary_calculations INSERT aligns with JPA (calculated_by, version=0). SQLEXCEPTION handler: GET DIAGNOSTICS before ROLLBACK; IFNULL fallback message.
-- New migration preserves checksums of applied V20260511_* files. Deploy: flyway migrate (or deploy_standardized_procedures.sh for procedure-only).
