# ⛔ IL 안정 PASS 전 — Actions 복귀 실행 금지

우선 가드: `.cursor/handoff/IL_STABILITY_PRIORITY_GUARD_20260915.md`
수신: `bc-4f1f3e4a` · `bc-35f7bbfb`
IL 컷오버 기준(심볼·헬스·번들) PASS 후에만 아래 절차 진행.
