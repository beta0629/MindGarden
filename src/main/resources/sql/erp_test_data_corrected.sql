-- ERP 시스템 테스트 데이터 생성 (올바른 테이블 구조에 맞춤)
-- 실제 계산 검증을 위한 샘플 데이터
...
(2001, 'PO-2024-001', '삼성전자', '02-1234-5678', 7500000.00, '2024-01-20', 'PENDING', 1, 'HQ', NOW(), NOW()),
(2002, 'PO-2024-002', 'LG전자', '02-2345-6789', 3000000.00, '2024-01-21', 'COMPLETED', 1, 'HQ', NOW(), NOW()),
(2003, 'PO-2024-003', '이케아', '02-3456-7890', 4000000.00, '2024-01-22', 'CANCELLED', 1, 'HQ', NOW(), NOW());
