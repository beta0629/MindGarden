...
class ClientMappingListPayloadServiceImplTest {
    ...
    @Test
    @DisplayName("productTitle/lineTotal/paymentAmount/paymentProvider 보강 + CREDIT_CARD 유지")
    void enrichsMoneyPathFields_andKeepsCanonicalCreditCardMethod() {
        ...
        ShopClientOrderLine line = ShopClientOrderLine.builder()
                .titleSnapshot("Shop 단회 상담권")
                .lineTotalMinor(55000L)
                .consultantClientMappingId(mappingId)
                .lineNo(1)
                .skuCodeSnapshot("SKU-1")
                .unitPriceMinor(55000L)
                .quantity(1)
                .build();
        line.setId(9001L);
        ...
        assertThat(row.get("paymentAmount")).isEqualTo(55000L);
        assertThat(row.get("productTitle")).isEqualTo("Shop 단회 상담권");
        assertThat(row.get("lineTotalMinor")).isEqualTo(55000L);
        ...
        assertThat(row.get("packagePrice")).isEqualTo(0L);
    ...
    @Test
    @DisplayName("paymentReference 있으나 Payment 미존재 시 paymentProvider null")
