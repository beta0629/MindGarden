...
export const ADMIN_USER_CREATE_COPY = {
  ...
  STAFF_TITLE: '스태프 추가',
  CARD_CLIENT_BASIC: '기본 정보',
  CARD_CLIENT_EXTRA: '부가 정보',
  CARD_CONSULTANT_ACCOUNT: '계정 정보',
  CARD_CONSULTANT_PRO: '전문 정보',
  LABEL_NAME: '이름',
  LABEL_EMAIL: '이메일',
  LABEL_CONTACT: '이메일 또는 연락처',
  LABEL_PHONE: '연락처',
  LABEL_PASSWORD: '비밀번호 (선택)',
  HINT_PASSWORD_AUTO: '미입력 시 서버에서 임시 비밀번호가 자동 생성됩니다.',
  LABEL_RRN: '주민등록번호',
  LABEL_RRN_FIRST: '앞 6자리',
  LABEL_RRN_LAST: '뒤 1자리',
  LABEL_ADDRESS: '주소',
  LABEL_CONSULTATION_PURPOSE_HISTORY: '상담 목적/이력',
  LABEL_SPECIALTY: '전문 분야',
  LABEL_QUALIFICATIONS: '자격 및 경력',
  LABEL_GRADE: '등급',
  PLACEHOLDER_EMAIL: '이메일',
  PLACEHOLDER_PHONE: '휴대폰 번호',
  PLACEHOLDER_ADDRESS: '주소를 입력해 주세요',
  PLACEHOLDER_PURPOSE: '상담 목적·이력 (선택)',
  PLACEHOLDER_QUALIFICATIONS: '자격·경력을 입력해 주세요',
  EMPTY_SPECIALTY_CODES: '등록된 전문분야 코드가 없습니다.',
  SUBMIT: '저장',
  ...
  VALIDATION_RRN: '주민번호 앞 6자리는 6자리 숫자, 뒤 1자리는 1~4로 입력해 주세요.',
  DUPLICATE_EMAIL: '이미 사용 중인 이메일입니다.',
  EMAIL_AVAILABLE: '사용 가능한 이메일입니다.',
  EMAIL_CHECKING: '이메일 확인 중…',
  ACCESS_STAFF_DENIED: '스태프 등록은 관리자만 가능합니다.',
  ACCESS_CONSULTANT_DENIED: '상담사 등록 권한이 없습니다.',
  /** 웹 ClientComprehensiveManagement 기본 grade */
  DEFAULT_CLIENT_GRADE: 'BRONZE',
