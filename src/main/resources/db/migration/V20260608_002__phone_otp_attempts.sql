-- =============================================================================
-- V20260608_002 — Apple SIWA 휴대폰 매칭 흐름용 OTP 시도 추적 테이블
-- (V20260608_001 은 develop 의 add_users_past_session_count 가 점유 — 시퀀스 +1)
--
-- 배경:
...
CREATE TABLE IF NOT EXISTS phone_otp_attempts (
  ...
  COMMENT='Apple SIWA 휴대폰 매칭 OTP 시도/한도 추적 (V20260608_002).';
