...
const RecurringExpenseModal = ({ isOpen, onClose }) => {
    ...
    const modalContent = (
        <div 
            ...
            style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', zIndex: 999999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', pointerEvents: 'auto' }}
            onClick={(e) => {
        ...
        >
            <div className="mg-v2-modal mg-v2-modal-large" style={{ position: 'relative', zIndex: 1000000, backgroundColor: 'white', maxWidth: '800px', padding: 0, borderRadius: '12px', boxShadow: '0 20px 40px rgba(0, 0, 0, 0.3)', pointerEvents: 'auto', overflow: 'hidden' }}>
