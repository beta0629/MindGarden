...
describe('ConsultationLogSessionHeaderMeta', () => {
  test('sessionNumber null 이면 1회기로 위조하지 않는다', () => {
    render(<ConsultationLogSessionHeaderMeta sessionNumber={null} sessionDateLabel="2026-09-14" />);
  ...
  test('유효 sessionNumber 는 N회기', () => {
    render(<ConsultationLogSessionHeaderMeta sessionNumber={3} sessionDateLabel="2026-09-14" />);
