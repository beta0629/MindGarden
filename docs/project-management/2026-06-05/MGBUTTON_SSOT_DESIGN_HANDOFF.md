...
| `--mg-actionbar-outline-bg` | `#ffffff` | `#1a1f2e` | outline fill |
| `--mg-actionbar-outline-text` | `#059669` | `#10b981` | outline 텍스트 |
...
### C.4 ActionBar — outline (light)

| 상태 | bg | text |
|---|---|---|
| default | white | #059669 |
| hover | #d1fae5 | #059669 |
| focus-visible | white | #059669 + inner 2px green shadow |
| active-press | #a7f3d0 | #059669 |
