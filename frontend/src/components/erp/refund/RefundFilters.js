        ...
        <div className="mg-v2-card-body">
          <div className="refund-filters-container">
            <div className="refund-filter-group">
              <label className="refund-filter-label" htmlFor="refund-filter-period">
                기간:
              </label>
              <select
            ...
            <div className="refund-filter-group">
              <label className="refund-filter-label" htmlFor="refund-filter-status">
                상태:
              </label>
              <select
            ...
            <ErpButton variant="info" onClick={onRefresh} icon={<FaSync />}>
              새로고침
            </ErpButton>

            <ErpButton variant="success" onClick={onExportExcel} icon={<FaDownload />}>
              엑셀 다운로드
            </ErpButton>
          </div>
        </div>
