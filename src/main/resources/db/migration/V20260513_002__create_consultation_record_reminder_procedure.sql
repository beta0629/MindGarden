-- CreateConsultationRecordReminder: 상담일지 미작성 알림 (8 IN + 3 OUT, Java PlSqlScheduleValidationServiceImpl 11 placeholders).
-- 본문은 database/schema/procedures_standardized/CreateConsultationRecordReminder_standardized.sql 과 동일.
