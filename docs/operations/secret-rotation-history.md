...
| 2026-07-02 02:36 | `DB_PASSWORD` (mindgarden_readonly) | `dev` | 정기 | [28536183876](https://github.com/beta0629/MindGarden/actions/runs/28536183876) | beta0629 | len=85, sha256=3a0d25a1 (구 키 N/A — 평문 미보유). 정책 §3.3 자동 회전 (BE 미사용). |
