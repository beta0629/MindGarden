    ...
    try {
      ...
      mermaid.initialize({
        ...
        themeVariables: {
          ...
          textColor: 'var(--mg-color-text-main)',
          edgeLabelBackground: 'var(--mg-white)',
          clusterBkg: 'var(--mg-gray-100)',
          clusterBorder: 'var(--mg-color-border-main)',
          ...
          signalTextColor: 'var(--mg-color-text-main)',
          labelBoxBkgColor: 'var(--mg-white)',
          labelBoxBorderColor: 'var(--mg-primary-500)',
          labelTextColor: 'var(--mg-color-text-main)',
          loopTextColor: 'var(--mg-color-text-main)',
