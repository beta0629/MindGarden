  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: theme.colors.bgMain }]} edges={['top']}>
      ...
      <AdminFabActionSheet
        ...
        cancelLabel={ADMIN_SCHEDULE_REGISTER_COPY.CANCEL}
        actions={[
          { label: ADMIN_MAPPING_COPY.FAB_SCHEDULE, onPress: openCreateSchedule },
          ...(canManageMappings
            ? [{ label: ADMIN_MAPPING_COPY.FAB_NEW_MAPPING, onPress: openCreateMapping }]
            : []),
        ]}
      />
