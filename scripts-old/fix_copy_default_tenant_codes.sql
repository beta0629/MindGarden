...
-- ============================================
-- 목적: is_active가 NULL인 경우도 처리하도록 수정
-- 작성일: 2025-11-26
-- ============================================
...
BEGIN
    ...
    SELECT 
        ...
        cc.code_description,
        cc.sort_order,
        COALESCE(cc.is_active, TRUE) AS is_active,  -- NULL인 경우 TRUE로 처리
        cc.color_code,
        cc.icon,
    ...
    AND COALESCE(cc.is_deleted, FALSE) = FALSE  -- NULL인 경우 FALSE로 처리
...
-- 완료 메시지
SELECT 'CopyDefaultTenantCodes 프로시저 수정 완료 (NULL 처리 개선)' AS message;
