...
> **범위**: `IntegratedMatchingSchedule` only — SidePeekShell stub/MVP, SessionProgress on card, DensityToggle (default comfortable, localStorage).  
...
- comfortable default + DensityToggle (compact default **off**)
