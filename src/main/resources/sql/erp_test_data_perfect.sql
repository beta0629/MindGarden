...
-- 4. 예산 테스트 데이터
INSERT INTO budgets (id, budget_code, name, description, category, total_budget, used_budget, remaining_budget, year, month, status, manager_id, start_date, end_date, notes, version, created_at, updated_at) VALUES
(3001, 'BUD-2024-001', '2024년 운영비', '2024년 운영비 예산', 'OPERATING', 100000000.00, 15000000.00, 85000000.00, 2024, 1, 'ACTIVE', 1, '2024-01-01', '2024-12-31', '연간 운영비', 0, NOW(), NOW()),
(3002, 'BUD-2024-002', '2024년 마케팅비', '2024년 마케팅비 예산', 'MARKETING', 50000000.00, 8000000.00, 42000000.00, 2024, 1, 'ACTIVE', 1, '2024-01-01', '2024-12-31', '연간 마케팅비', 0, NOW(), NOW()),
(3003, 'BUD-2024-003', '2024년 장비비', '2024년 장비비 예산', 'EQUIPMENT', 30000000.00, 12000000.00, 18000000.00, 2024, 1, 'ACTIVE', 1, '2024-01-01', '2024-12-31', '연간 장비비', 0, NOW(), NOW()),
(3004, 'BUD-2024-004', '2024년 인사비', '2024년 인사비 예산', 'PERSONNEL', 200000000.00, 45000000.00, 155000000.00, 2024, 1, 'ACTIVE', 1, '2024-01-01', '2024-12-31', '연간 인사비', 0, NOW(), NOW());

-- 5. 재무 거래 테스트 데이터 (올바른 컬럼명 사용)
INSERT INTO financial_transactions (id, description, amount, amount_before_tax, tax_amount, tax_included, transaction_type, category, subcategory, transaction_date, status, department, project_code, related_entity_id, related_entity_type, remarks, approval_comment, approved_at, approver_id, category_code_id, subcategory_code_id, is_deleted, created_at, updated_at) VALUES
(4001, '노트북 구매', 7500000.00, 6818181.82, 681818.18, true, 'EXPENSE', 'EQUIPMENT', 'COMPUTER', '2024-01-20', 'COMPLETED', 'IT팀', 'PRJ-001', 2001, 'PURCHASE_ORDER', '개발용 노트북 5대 구매', '승인', NOW(), 1, NULL, NULL, false, NOW(), NOW()),
(4002, '모니터 구매', 3000000.00, 2727272.73, 272727.27, true, 'EXPENSE', 'EQUIPMENT', 'MONITOR', '2024-01-21', 'COMPLETED', 'IT팀', 'PRJ-001', 2002, 'PURCHASE_ORDER', '24인치 모니터 10대 구매', '승인', NOW(), 1, NULL, NULL, false, NOW(), NOW()),
(4003, '월급 지급', 45000000.00, 45000000.00, 0.00, false, 'EXPENSE', 'PERSONNEL', 'SALARY', '2024-01-25', 'COMPLETED', '인사팀', 'PRJ-002', NULL, NULL, '2024년 1월 직원 월급', '승인', NOW(), 1, NULL, NULL, false, NOW(), NOW()),
(4004, '상담 수익', 5000000.00, 4545454.55, 454545.45, true, 'INCOME', 'CONSULTATION', 'SERVICE', '2024-01-30', 'COMPLETED', '상담팀', 'PRJ-003', NULL, NULL, '2024년 1월 상담 수익', '승인', NOW(), 1, NULL, NULL, false, NOW(), NOW()),
(4005, '마케팅 비용', 2000000.00, 1818181.82, 181818.18, true, 'EXPENSE', 'MARKETING', 'ADVERTISING', '2024-02-01', 'COMPLETED', '마케팅팀', 'PRJ-004', NULL, NULL, '온라인 광고비', '승인', NOW(), 1, NULL, NULL, false, NOW(), NOW());
