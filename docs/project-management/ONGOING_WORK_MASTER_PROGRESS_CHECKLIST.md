...
**최종 갱신**: 2026-04-11 (G8-B13a/B13b·마스터 진행도 반영)  
...
- **전역 확대 검토 상태**: 🔄 — **G7·CL-B1·G8-B1a~B13b** 일부 ☑; **G-01** 잔여 — `components/dashboard`(위젯 외)·`admin`·`schedule`·`client`·`consultant`·`erd`·`academy`·위젯 `*.js.js` 중복본 등 `rg '<button'` 인벤토리(테스트·`*_backup*`·`MGButton.js`·`BaseButton` 래퍼 제외 권장).
