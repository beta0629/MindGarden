...
**baseline develop**: `419a0177d` (PR #545 ROLE-03 Expo wiring · prior #544 P0-3~4 hooks · #543 DASH-03~04) · **prod sign-off 없음 · prod 금지**  
...
| **CP-6** | `HF-02` header title hotfix dev 검증 (F1~F6) | 07-08 ~ 07-10 | ☑ F1~F6 PASS · bundle `main.4278ef57.js` · run `28875323851` · headerDedup 7/7 |
| **CP-6b** | `ROLE-03` P0-3~4 Expo consultant home | 07-07 ~ 07-08 | ☑ #544 `482e7e7a0` + #545 `419a0177d` |
| **CP-7** | `GATE-03` 7/13 dev 통합 sign-off | **07-13** | CP-2~6 · CP-6b · GATE-02 시트 준비 ☑ |

**슬랙(버퍼)**: Role Dashboard freeze 검수(`ROLE-01`) · **`ROLE-03` P0-2 Renewal → post-GATE-03 defer 권고** · orphan 결정 대기 항목은 CP 실패 시 7/13에서 **범위 축소** 가능.
...
| 항목 | 상태 | 다음 액션 | 담당 |
|------|------|-----------|------|
| **HF-02** header 6 routes dev verify | ☑ F1~F6 PASS | `main.4278ef57.js` · GATE-02 §F |
| **GATE-03** manual checklist prep | ☑ | GATE-02 G3·sign-off 시트 초안 — **사용자 7/13** |
| **ROLE-03 P0-2** Renewal API 교정 | **defer** | post-GATE-03 · blocking 아님 |
| **Expo OTA** | **report only** | publish 금지 · `eas.json` channels |

**develop HEAD**: `419a0177d` — `feat(expo): wire consultant home P1 index to ROLE-03 hooks (#545)`  
**ROLE-03 P0-3~4**: ☑ #544 hooks·organisms + #545 `(home)/index.tsx` wiring  
**dev FE bundle (latest deploy)**: #543 @ run `28875323851` — #545는 Expo-only · FE redeploy 불필요  
**CI (#545)**: merge 직후 in_progress → green 확인 후 overnight handoff 고정
...
| `DASH-10` | PR-DASH-10 sign-off evidence pack | core-planner | **07-13** | DASH-09 · GATE-03 | 스크린·run ID·good SHA 단일 표 · **Design Freeze Sign-off** · evidence: [`DASH_10_EVIDENCE_PACK_20260713.md`](../../guides/testing/DASH_10_EVIDENCE_PACK_20260713.md) · CP-7 sign-off: [`GATE_03_USER_SIGNOFF_SHEET_20260713.md`](../../guides/testing/GATE_03_USER_SIGNOFF_SHEET_20260713.md) | dev |
...
| `ROLE-03` | Consultant 대시보드 3축 (App/Web 분리) | core-planner → core-coder | 07-10~14 | `SAFE-03` (#534 merge) · ROLE-02 | **순서 고정**: (1) **P0-6 Web V2 polish** ☑ (#539) → (2) **P0-3~4 Expo P1** ☑ (#544+#545) → (3) **P0-2 Renewal API 교정** — **post-GATE-03 defer 권고** (`ConsultantDashboardRenewal` StandardizedApi; V2 SSOT). 스펙 SSOT: [`SCREEN_SPEC_CONSULTANT_DASHBOARD_V2_ENHANCED.md`](../../design-system/SCREEN_SPEC_CONSULTANT_DASHBOARD_V2_ENHANCED.md). App/Web UI 크로스 링크 0 | dev |
| `ROLE-04` | Role dashboard Jest/E2E smoke | core-tester | 07-11~12 | ROLE-01~02 · ROLE-03 P0-3~4 | Expo Jest ☑ 4/32 (#544+#545) · **[QA GATE] Visual smoke + headerDedup + dark cascade PASS** · `/client`·`/consultant` 스모크 · #130 0 | dev |
...
| P0-3~4 | Expo API 훅 + 홈 P1 UI | core-coder | ☑ #544+#545 @ `419a0177d` |
| P0-2 | Renewal API 교정 | core-coder | **defer post-GATE-03** (V2 SSOT · Renewal deprecated) |
...
| P1 Role | core-coder | ☑ Dash | `ROLE-03` P0-3~4 ☑ · **P0-2 defer** · `ROLE-04` Expo Jest gate | frontend, atomic-design |
| **Overnight-1** | **core-tester** | ☑ | `HF-02` F1~F6 ☑ + `GATE-03` checklist prep ☑ | testing |
| **Overnight-2** | **core-coder** | ☑ | `ROLE-04` Expo Jest ☑ — 4 suites/32 tests PASS · GATE-03 Expo 수동 갭은 tester G3 | testing, frontend |
| Post 7/13 | core-planner | — | `GATE-03` evidence · Phase 8 kickoff · `ROLE-03` P0-2 착수 여부 | planning, deployment |
...
- [ ] `ADM-01` dark-c3b ☑
- [x] `HF-02` header hotfix dev 검증 ☑ (F1~F6 @ bundle `main.4278ef57.js` · run `28875323851`)
- [ ] `HF-03` session Error Boundary ☑ 또는 7/13 defer 명시
- [ ] `ROLE-01` Client v1.3 freeze ☑ (`CLIENT_DASHBOARD_REBUILD_HANDOFF_v1.3.md`)
- [x] `ROLE-03` P0-6 Web V2 polish ☑ (#539) · P0-3~4 Expo ☑ (#544+#545 @ `419a0177d`)
- [ ] `ROLE-03` P0-2 Renewal — **post-GATE-03 defer** (사용자 명시 시 착수)
- [x] `ROLE-04` Expo consultant home Jest ☑ (4 suites/32 tests @ `419a0177d`) · GATE-03 Expo 수동 스모크 ◐
...
| 2026-07-08 (5차) | develop `419a0177d` (#545) · ROLE-03 P0-3~4 ☑ · Overnight CP ☑ — HF-02 F1~F6 · GATE-03 prep · ROLE-04 Jest |
| 2026-07-08 (6차) | Overnight handoffs 완료 — HF-02+GATE-03 prep · ROLE-04 Jest · CP-7 사용자 sign-off만 잔여 |
| 2026-07-08 (7차) | DASH-10 evidence pack·GATE-03 1-pager 신규 — [`DASH_10_EVIDENCE_PACK_20260713.md`](../../guides/testing/DASH_10_EVIDENCE_PACK_20260713.md) · [`GATE_03_USER_SIGNOFF_SHEET_20260713.md`](../../guides/testing/GATE_03_USER_SIGNOFF_SHEET_20260713.md) cross-link |
