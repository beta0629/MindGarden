...
-- 스케줄 관련 통계
INSERT INTO statistics_definitions (tenant_id, statistic_code, statistic_name_ko, statistic_name_en, category, calculation_type, data_source_type, calculation_rule, aggregation_period, display_order, description) VALUES
...
(NULL, 'AVERAGE_CONSULTATION_DURATION', '평균 상담 시간', 'Average Consultation Duration', 'SCHEDULE', 'AVG', 'SCHEDULE', 
 ...
 'DAILY', 50, '최근 30일 완료된 상담의 평균 시간 (분)'),
