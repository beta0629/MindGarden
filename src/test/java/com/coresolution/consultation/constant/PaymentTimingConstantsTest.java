 ...
 * @since 2026-09-14
 */
@DisplayName("PaymentTimingConstants — 타기관 연계 가예약 분리")
class PaymentTimingConstantsTest {

    @Test
    @DisplayName("INSTITUTION_LINK 만 isInstitutionLink, 가예약 remaining 우회 대상")
    void institutionLink_isDistinctFromSessionPack() {
        ...
        assertThat(PaymentTimingConstants.allowsTentativeScheduleWithoutRemaining(
                PaymentTimingConstants.INSTITUTION_LINK)).isTrue();
        assertThat(PaymentTimingConstants.allowsTentativeScheduleWithoutRemaining(
                PaymentTimingConstants.SAME_DAY_CARD)).isTrue();
        assertThat(PaymentTimingConstants.allowsTentativeScheduleWithoutRemaining(
                PaymentTimingConstants.ADVANCE)).isFalse();
        assertThat(PaymentTimingConstants.allowsTentativeScheduleWithoutRemaining(null)).isFalse();
    }
