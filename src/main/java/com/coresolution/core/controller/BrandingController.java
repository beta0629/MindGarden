...
public class BrandingController {
    ...
    public ResponseEntity<BrandingInfo> getBrandingInfo() {
        ...
        return ResponseEntity.ok(brandingInfo);
    }
    ...
    public ResponseEntity<BrandingInfo> getBrandingInfoByTenantId(
    ...
    public ResponseEntity<BrandingInfo> updateBrandingInfo(
    ...
    public ResponseEntity<BrandingInfo> uploadLogo(
    ...
    public ResponseEntity<BrandingInfo> uploadLogoForTenant(
            @Parameter(description = "테넌트 ID") @PathVariable String tenantId,
            @Parameter(description = "로고 이미지 파일 (PNG, JPG, SVG, 최대 5MB)")
            @RequestParam("logo") MultipartFile logoFile) {
    ...
    public ResponseEntity<BrandingInfo> updateBrandingInfoForTenant(
            @Parameter(description = "테넌트 ID") @PathVariable String tenantId,
            @Parameter(description = "브랜딩 정보 업데이트 요청") @Valid @RequestBody BrandingUpdateRequest request) {
