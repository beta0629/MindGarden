...
-- 본점 수입
('INCOME', '상담료', 'INDIVIDUAL_CONSULTATION', 150000, '개별 상담료', '2025-09-01', 'COMPLETED', 'MAIN001', false, NOW(), NOW()),
('INCOME', '상담료', 'GROUP_CONSULTATION', 200000, '그룹 상담료', '2025-09-02', 'COMPLETED', 'MAIN001', false, NOW(), NOW()),
...
('INCOME', '상담료', 'INDIVIDUAL_CONSULTATION', 180000, '개별 상담료', '2025-09-01', 'COMPLETED', 'GANGNAM', false, NOW(), NOW()),
('INCOME', '상담료', 'GROUP_CONSULTATION', 250000, '그룹 상담료', '2025-09-02', 'COMPLETED', 'GANGNAM', false, NOW(), NOW()),
...
('INCOME', '상담료', 'INDIVIDUAL_CONSULTATION', 160000, '개별 상담료', '2025-09-01', 'COMPLETED', 'HONGDAE', false, NOW(), NOW()),
('INCOME', '상담료', 'GROUP_CONSULTATION', 220000, '그룹 상담료', '2025-09-02', 'COMPLETED', 'HONGDAE', false, NOW(), NOW()),
...
('INCOME', '상담료', 'INDIVIDUAL_CONSULTATION', 140000, '개별 상담료', '2025-09-01', 'COMPLETED', 'JAMSIL', false, NOW(), NOW()),
('EXPENSE', 'SALARY', 'CONSULTANT_SALARY', 2500000, '상담사 급여', '2025-09-01', 'COMPLETED', 'JAMSIL', false, NOW(), NOW()),

-- 5. 신촌점 (SINCHON) 테스트 데이터
('INCOME', '상담료', 'INDIVIDUAL_CONSULTATION', 170000, '개별 상담료', '2025-09-01', 'COMPLETED', 'SINCHON', false, NOW(), NOW()),
