...
**현재 구현 상태 (2025-11-27):**
- 🔄 **단계적 전환**: 현재는 UserRole enum 기반, 향후 동적 시스템으로 전환 예정
- ✅ **새 역할 추가**: PRINCIPAL(원장), OWNER(사장), TENANT_ADMIN(테넌트관리자) 역할 추가
- 🔄 **동적 시스템**: RoleTemplate, TenantRole, UserRoleAssignment 구조 설계 완료
