...
class SalaryManagementControllerIntegrationTest {
    ...
    @Nested
    @DisplayName("늦은 회기 Recalc/Adjustment (I-LATE)")
    class LateNotesRecalcAdjustment {
        ...
        @Test
        @DisplayName("I-LATE-02: PAID 후 Adjust → new ADJUSTMENT 30000/tax990; 2nd adjust refuses")
        ...
        @Test
        @DisplayName("I-LATE-05: GET /pre-confirm-warning 정보만 반환 (hard-block 아님)")
