...
@Slf4j
@RestController
@RequestMapping({"/api/v1/erp", "/api/erp"}) // v1 경로 추가, 레거시 경로 유지
...
public class ErpController extends BaseApiController {
    ...
    public ResponseEntity<ApiResponse<RecurringExpense>> createRecurringExpense(@RequestBody RecurringExpense recurringExpense, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiResponse<RecurringExpense>> updateRecurringExpense(@PathVariable Long id, @RequestBody RecurringExpense recurringExpense, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> deleteRecurringExpense(@PathVariable Long id) {
    ...
    public ResponseEntity<ApiResponse<Void>> processRecurringExpense(@PathVariable Long id, @RequestParam(required = false) BigDecimal customAmount) {
    ...
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getCommonCodesByGroup(@PathVariable String codeGroup) {
