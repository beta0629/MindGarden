...
**최종 갱신**: 2026-04-11 (G8-B8a/B8b·마스터 진행도 반영)  
...
- **전역 확대 검토 상태**: 🔄 — **G7·CL-B1·G8-B1a~B8b** 일부 ☑; **G-01** 잔여 — `AdminDashboard.js`·`CommonCodeManagement`·`ops/PgApprovalManagement`·위젯 등 `rg '<button'` 인벤토리(테스트·`*_backup*` 제외 권장).
