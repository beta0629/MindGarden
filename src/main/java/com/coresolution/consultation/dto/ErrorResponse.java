 ...
 * 
 * @deprecated Use {@link com.coresolution.core.dto.ErrorResponse} instead.
 * This class is deprecated in favor of the standardized ErrorResponse in core.dto package.
 * This class will be removed in version 2.0.0.
 * 
 * Migration guide:
 * - Replace: import com.coresolution.consultation.dto.ErrorResponse;
 * - With: import com.coresolution.core.dto.ErrorResponse;
 * 
 * The API is identical, so no code changes are needed except the import statement.
 */
@Deprecated
@Data
@Builder
