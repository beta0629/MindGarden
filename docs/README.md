...
| **[design-system/](./design-system/)** | 디자인 시스템·토큰·컴포넌트 스펙 | [Clinic-OS 어드민 비주얼 SSOT](./design-system/CLINIC_OS_ADMIN_VISUAL_SSOT.md), [잔여 화면 인벤토리](./design-system/CLINIC_OS_REMAINING_SCREENS.md), v2 등. [design-system/README.md](./design-system/README.md) |
...
- **[쇼핑·리워드 플랫폼 오케스트레이션](./project-management/SHOP_REWARD_PLATFORM_ORCHESTRATION.md)** — Core 엔진 vs MindGarden 테넌트·MVP·갭·서브에이전트 분배 SSOT
- **[멀티테넌트 쇼핑·마켓플레이스 (B2C 입점)](./project-management/MULTI_TENANT_SHOP_MARKETPLACE_SPEC.md)** — 테넌트 몰 vs 통합 마켓·입점·방향성 7원칙·Phase 1~4·E-MKT/E-AGG
