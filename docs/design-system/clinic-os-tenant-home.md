...
| 5 | Policy legal footer | Tenant DB merchant-legal fields + **4 public links** `/legal/terms` · `/legal/privacy` · `/legal/products` · `/legal/refund`; placeholders only when empty; no MindGarden literals |
