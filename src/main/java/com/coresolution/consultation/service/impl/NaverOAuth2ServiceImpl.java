...
public class NaverOAuth2ServiceImpl extends AbstractOAuth2Service {
    ...
    public String getAccessToken(String code, String redirectUri) {
        ...
        try {
            ...
            log.info("네이버 토큰 요청 전체 파라미터: grant_type={}, client_id={}, client_secret={}, redirect_uri={}, code={}", 
                     "authorization_code", clientId, clientSecret != null ? clientSecret.substring(0, Math.min(5, clientSecret.length())) + "..." : "null", 
                     redirectUriToUse, code != null ? code.substring(0, Math.min(10, code.length())) + "..." : "null");
            ...
            if (tokenInfo.containsKey("error")) {
                ...
                log.error("네이버 OAuth2 에러 응답: error={}, description={}, redirect_uri={}, raw={}", 
                        error, errorDescription, redirectUriToUse, tokenInfo);
