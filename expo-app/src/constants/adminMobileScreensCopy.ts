...
/** @see adminHomeCopy.ts — 홈 SSOT */
export { ADMIN_HOME_ROUTES, ADMIN_MOBILE_HOME_COPY } from './adminHomeCopy';
...
export const ADMIN_MOBILE_MORE_COPY = {
  ...
  NOTIFICATION_CENTER_SUB: '푸시·시스템 알림 목록',
  NOTIFICATIONS_SCREEN_TITLE: '알림',
  BACK_TO_MORE_A11Y: '더보기 메뉴로',
