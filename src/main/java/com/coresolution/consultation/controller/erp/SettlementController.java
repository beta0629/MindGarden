...
public class SettlementController extends BaseApiController {
     ...
     */
    @PostMapping("/rules")
    public ResponseEntity<ApiResponse<SettlementRule>> createRule(@RequestBody SettlementRuleCreateRequest request) {
    ...
    /**
     * 정산 계산 실행
     * POST /api/v1/erp/settlement/calculate?period=202512
     * 표준 문서: docs/standards/ERP_ADVANCEMENT_STANDARD.md
     */
    ...
    public ResponseEntity<ApiResponse<Settlement>> approveSettlement(
        ...
        Settlement approved = settlementService.approveSettlement(tenantId, id, request.getApproverId());
