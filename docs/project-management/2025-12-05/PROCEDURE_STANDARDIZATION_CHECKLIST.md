...
### 4.1 나머지 프로시저 표준화 (약 32개)

각 프로시저마다 다음 체크리스트 적용:
...
| Phase 2 | 재무/회계 프로시저 표준화 | 0% | 🔴 대기 | - |
| Phase 3 | 통계/리포트 프로시저 표준화 | 0% | 🔴 대기 | - |
| Phase 4 | 기타 프로시저 표준화 | 0% | 🔴 대기 | - |
...
### Phase 2 완료 체크
- [ ] ApplyDiscountAccounting 표준화 완료
- [ ] ProcessRefundWithSessionAdjustment 표준화 완료
- [ ] ProcessIntegratedSalaryCalculation 표준화 완료
- [ ] ProcessSalaryPaymentWithErpSync 표준화 완료
- [ ] ValidateIntegratedAmount 표준화 완료
- [ ] 통합 테스트 통과

### Phase 3 완료 체크
- [ ] GetConsolidatedFinancialData 표준화 완료
- [ ] GenerateFinancialReport 표준화 완료
- [ ] GetRefundableSessions 표준화 완료
- [ ] GetRefundStatistics 표준화 완료
- [ ] GetIntegratedSalaryStatistics 표준화 완료
- [ ] 통합 테스트 통과

### Phase 4 완료 체크
- [ ] 나머지 프로시저 표준화 완료 (약 32개)
- [ ] 통합 테스트 통과
