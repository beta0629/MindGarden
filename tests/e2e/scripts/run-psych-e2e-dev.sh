...
# 기본 계정: agisunny@daum.net / godgod826! (SSOT: .cursor/skills/core-solution-testing/SKILL.md)
...
export TEST_USERNAME="${TEST_USERNAME:-agisunny@daum.net}"
export TEST_PASSWORD="${TEST_PASSWORD:-godgod826!}"
