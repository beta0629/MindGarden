...
### 🎨 프론트엔드 자동 선택 로직
- [x] **commonCodeApi.js 개선**
  - [x] 테넌트 코드 그룹 정의 (TENANT_CODE_GROUPS)
  - [x] 자동 API 선택 로직 구현
  - [x] getTenantCodesByGroup, getCommonCodes 함수 개선
- [x] **주요 컴포넌트 업데이트**
  - [x] ClientComprehensiveManagement.js
  - [x] ConsultantComprehensiveManagement.js  
  - [x] MappingCreationModal.js
  - [x] MappingEditModal.js
  - [x] UserManagement.js
  - [x] consultantHelper.js
...
- [x] **온보딩 테스트 성공**
  - [x] test-onboarding-with-admin-account.sh 실행
  - [x] 테넌트 ID 생성: tenant-seoul-consultation-002
  - [x] 관리자 계정 생성: test-20251125-175255@example.com
- [x] **테넌트 독립성 검증**
