...
### 마스터 플랜 업데이트
- 표준화 상태 반영
- 학원 기능 MindGarden 수준 완성 작업 추가 (4주)
- 학원 ERP 연동 추가 (수강료, 강사 급여, 운영비)
...
### P1 - 중요
1. 동적 대시보드 Phase 3 테스트
2. Controller 표준화 점진적 처리 (낮은 우선순위)
...
### 어제 날짜 폴더 (2025-11-22)
- [마스터 통합 계획](./MASTER_INTEGRATED_PLAN.md)
