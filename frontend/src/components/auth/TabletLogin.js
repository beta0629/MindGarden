...
const TabletLogin = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // 로그인 성공 알림
        showTooltip(t('auth:common.loginSuccessMessage'), 'success');
        ...
        const modalData = {
          isOpen: true,
          message: result.message || t('auth:tabletLogin.msg.duplicateLoginPrompt'),
          loginData: formData
        };
  ...
  const handleSmsAuthSuccess = async() => {
    try {
      ...
      showTooltip(t('auth:tabletLogin.msg.smsAuthError'), 'error');
    }
  };
    ...
    <div className={TABLET_LOGIN_CSS.CONTAINER}>
      <div className={TABLET_LOGIN_CSS.CONTENT}>
          <div className={TABLET_LOGIN_CSS.HEADER}>
            <h1 className={TABLET_LOGIN_CSS.TITLE}>{t('auth:tabletLogin.title')}</h1>
            <p className={TABLET_LOGIN_CSS.SUBTITLE}>{t('auth:tabletLogin.subtitle')}</p>
          </div>
          ...
          {!smsMode ? (
            ...
            <form className={TABLET_LOGIN_CSS.FORM} onSubmit={handleSubmit}>
              <div className={TABLET_LOGIN_CSS.FORM_GROUP}>
                ...
                <input
                  ...
                  placeholder={t('auth:tabletLogin.emailPlaceholder')}
                  required
                />
              </div>
              ...
              <div className={TABLET_LOGIN_CSS.FORM_GROUP}>
                <label className={TABLET_LOGIN_CSS.LABEL}>
                  ...
                  {t('auth:tabletLogin.passwordLabel')}
                </label>
                <div className={TABLET_LOGIN_CSS.INPUT_GROUP}>
                  <input
                    ...
                    onChange={handleInputChange}
                    className={TABLET_LOGIN_CSS.INPUT}
                    placeholder={t('auth:tabletLogin.passwordPlaceholder')}
                    required
                  />
                  <MGButton
                    type="button"
              ...
              <MGButton
                ...
                preventDoubleClick={false}
              >
                {t('auth:tabletLogin.loginButton')}
              </MGButton>
              ...
              <div className="tablet-login-forgot-password">
                ...
                >
                  {t('auth:tabletLogin.forgotPassword')}
                </MGButton>
              </div>
            </form>
          ) : (
            ...
            <div className={TABLET_LOGIN_CSS.SMS_SECTION}>
                ...
                <div className={TABLET_LOGIN_CSS.INPUT_GROUP}>
                  ...
                  >
                    {isCodeSent && countdown > 0
                      ...
                      : t('auth:tabletLogin.sendVerificationCode')
                    }
                  </MGButton>
                </div>
              </div>
              ...
              {isCodeSent && (
                <div className={TABLET_LOGIN_CSS.FORM_GROUP}>
                  <label className={TABLET_LOGIN_CSS.LABEL}>
                    ...
                    {t('auth:tabletLogin.verificationCodeLabel')}
                  </label>
                  <div className={TABLET_LOGIN_CSS.SMS_VERIFICATION}>
                    <input
                      ...
                      placeholder={t('auth:tabletLogin.verificationCodePlaceholder')}
                      maxLength="6"
                    />
                    <MGButton
                      type="button"
                      ...
                      preventDoubleClick={false}
                    >
                      {t('auth:tabletLogin.verifyButton')}
                    </MGButton>
                  </div>
                </div>
              )}
              ...
              <MGButton
                ...
                preventDoubleClick={false}
              >
                {t('auth:tabletLogin.smsLoginButton')}
              </MGButton>
            </div>
          )}
          ...
          <div className={TABLET_LOGIN_CSS.SOCIAL_BUTTONS}>
            ...
            >
              ...
              {t('auth:tabletLogin.socialLogin.kakao')}
            </MGButton>
            <MGButton
              type="button"
              variant="outline"
            ...
            >
              <i className="bi bi-n" />
              {t('auth:tabletLogin.socialLogin.naver')}
            </MGButton>
          </div>

          <div className={TABLET_LOGIN_CSS.FOOTER}>
            <p className="register-link">
              {t('auth:tabletLogin.registerHint')}{' '}
              <MGButton
                type="button"
                variant="outline"
        ...
        <>
          ...
          >
            ...
            <div className="tablet-login-notification__hint">
              {t('auth:tabletLogin.tooltipDismissHint')}
            </div>
          </div>
