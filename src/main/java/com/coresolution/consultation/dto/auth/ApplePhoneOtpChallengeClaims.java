...
/**
 * Apple SIWA 휴대폰 매칭 흐름 2단계 토큰({@code otpChallengeToken}) 의 클레임.
 *
 * <p>발급 조건: {@code POST /api/v1/auth/oauth/apple/phone/send} 호출 성공 시 응답 본문에 포함.
...
@Value
@Builder
public class ApplePhoneOtpChallengeClaims {
    ...
    /** Apple sub — phoneVerificationToken 과 일치 검증용. */
