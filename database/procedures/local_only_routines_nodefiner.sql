...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 -- !!! SSOT 2026-08-29: use procedures_standardized + V20260829_003__salary_preview_confirm_parity.sql (not this dump body)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `GetConsultationRecordMissingStatistics`(IN p_check_date DATE,IN p_branch_code VARCHAR(20),OUT p_missing_count INT,OUT p_alerts_created INT,OUT p_success BOOLEAN,OUT p_message TEXT)
