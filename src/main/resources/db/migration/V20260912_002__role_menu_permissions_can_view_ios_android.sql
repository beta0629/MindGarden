...
-- - 기존 can_view = 웹/레거시
-- - 신규 컬럼은 can_view 복사만 (커뮤니티 사전 OFF 시드 금지)
-- - 심사 시 커뮤니티 iOS 숨김은 Admin 원버튼으로 적용
