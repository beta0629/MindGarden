...
export default function MindGardenDesignSystem() {
  ...
  return (
    <div className="mindgarden-design-system min-h-screen bg-gradient-to-br from-[#F5F5DC] via-[#FDF5E6] to-[#B6E5D8] transition-colors duration-500">
      <Button
        variant="outline"
        size="icon"
