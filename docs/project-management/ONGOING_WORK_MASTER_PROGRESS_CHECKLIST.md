...
**최종 갱신**: 2026-05-04 — 통합 스케줄 FullCalendar **CSS 아키텍처 가상 회의·전면 개선** 배치 착수: [`INTEGRATED_SCHEDULE_CALENDAR_CSS_ARCHITECTURE_ORCHESTRATION.md`](./2026-04-28/INTEGRATED_SCHEDULE_CALENDAR_CSS_ARCHITECTURE_ORCHESTRATION.md)(KR 공휴일 데이터 SSOT·클라이언트 노트 문서와 교차 참조). · 2026-05-05 — 통합 스케줄 범례 이모지 제거·RTL·빌드 검증 완료. · 2026-05-05 — CI에 통합 스케줄 Playwright 워크플로 연결·워크플로 인덱스 33개·시크릿 게이트는 기존 E2E와 동형이며, 실제 회귀는 `E2E_BASE_URL`·자격 전제. · 2026-05-04 — 통합 스케줄 **KR 공휴일** SSOT·후속 분배 문서 착수·`INTEGRATED_SCHEDULE_CLIENT_NOTES_ORCHESTRATION.md` 교차 링크·정적 연도 2024–2028 한계 명시: [`INTEGRATED_SCHEDULE_KR_HOLIDAYS_ORCHESTRATION.md`](./2026-04-28/INTEGRATED_SCHEDULE_KR_HOLIDAYS_ORCHESTRATION.md). · 2026-04-17 — 통합 스케줄 특이사항 옵션 C + Phase 1.1(월간 아이콘·모달 배너·API 이원 필드)·INTEGRATED_SCHEDULE_CLIENT_NOTES_ORCHESTRATION.md §12.3·백엔드 ClientScheduleNoteRepositoryTest/ScheduleControllerAdminIntegrationTest·프론트 Jest scheduleUnresolvedNotes 연계; [ERP_FINANCIAL_HUB_SMOKE.md](../guides/testing/ERP_FINANCIAL_HUB_SMOKE.md)·[`tests/e2e/README.md`](../../tests/e2e/README.md)에 **E2E 선행 조건** 반영; `AdminServiceUserFacingMessages`·`AdminServiceImpl` 매칭·스케줄 노트 사용자 문구 상수화; 메뉴권한 `MenuPermissionManagementUI`/`menuPermissionManagementStrings`·부모 정리; Playwright `tests/e2e/test-results` **저장소 비추적**(.gitignore). 복사 실행: [NEXT_LOCAL_VERIFICATION_COMMANDS.md](./NEXT_LOCAL_VERIFICATION_COMMANDS.md). **RESV-ALIM-P0** 잔여·§1·§11.13·테스터 매트릭스: [RESERVATION_KAKAO_ALIMTALK_ORCHESTRATION_CHECKLIST.md](./2026-04-23/RESERVATION_KAKAO_ALIMTALK_ORCHESTRATION_CHECKLIST.md). 문자열 다음 배치: [USER_FACING_STRINGS_AND_HARDCODE_NEXT_BATCH.md](./2026-04-21/USER_FACING_STRINGS_AND_HARDCODE_NEXT_BATCH.md). **UI-01** 다음 주·**App.js**는 RESV와 직렬(플래너 SSOT). **CONSULT-NOTIF-P1**(Consultant 스tub 알림)은 RESV-P0와 분리 권고. **ZERO-DT-01** 무중단 갭·로드맵·배포 직후 검증 SSOT는 [ZERO_DOWNTIME_GAP_AND_ROADMAP.md](../deployment/ZERO_DOWNTIME_GAP_AND_ROADMAP.md)·[ZERO_DOWNTIME_POST_DEPLOY_CHECKLIST.md](../guides/testing/ZERO_DOWNTIME_POST_DEPLOY_CHECKLIST.md)에서 착수·동기화한다.  
...
| **RESV-ALIM-P0** | 예약 × 알림톡 — 1~2차 ☑ + **3차** explore·designer·coder·tester·deployer(§11.8~§11.13) → **프론트·전체 mvn·테스터 전 매트릭스·§1·§11.13 TODO** 잔여 | 🔄 문서·E2E 선행조건·BE strings 반영 후 코드 매트릭스 | 🔄 | [체크리스트](./2026-04-23/RESERVATION_KAKAO_ALIMTALK_ORCHESTRATION_CHECKLIST.md) §7·§10·§11 — Consultant REST 스tub 알림은 **CONSULT-NOTIF-P1** 분리 |
| **ZERO-DT-01** | 무중단(블루그린·동등) 요구 대비 — 저장소 워크플로·Go-Live·배포 인덱스 정합·갭·로드맵 SSOT | core-planner | 🔄 | [ZERO_DOWNTIME_GAP_AND_ROADMAP.md](../deployment/ZERO_DOWNTIME_GAP_AND_ROADMAP.md) · 배포·컷오버 직후 검증 [ZERO_DOWNTIME_POST_DEPLOY_CHECKLIST.md](../guides/testing/ZERO_DOWNTIME_POST_DEPLOY_CHECKLIST.md) |
