...
import { 
  ...
  BRANCH_BRANCH_SUPER_ADMIN_MENU_ITEMS,
...
const SimpleHamburgerMenu = ({ isOpen, onClose }) => {
  ...
  const getMenuStructure = () => {
    ...
    const roleMenuConfig = {
      ...
      [USER_ROLES.BRANCH_BRANCH_SUPER_ADMIN]: {
        mainMenus: [
          ...commonMainMenus,
          BRANCH_BRANCH_SUPER_ADMIN_MENU_ITEMS.MAIN.ADMIN,
          BRANCH_BRANCH_SUPER_ADMIN_MENU_ITEMS.MAIN.USERS,
          BRANCH_BRANCH_SUPER_ADMIN_MENU_ITEMS.MAIN.FINANCE,
          BRANCH_BRANCH_SUPER_ADMIN_MENU_ITEMS.MAIN.ERP
        ],
        subMenus: BRANCH_BRANCH_SUPER_ADMIN_MENU_ITEMS.SUB
      },
      [USER_ROLES.ADMIN]: {
        mainMenus: [
          ...commonMainMenus,
      ...
      [USER_ROLES.BRANCH_SUPER_ADMIN]: {
        mainMenus: [
          ...
          BRANCH_SUPER_ADMIN_MENU_ITEMS.MAIN.SYSTEM,
