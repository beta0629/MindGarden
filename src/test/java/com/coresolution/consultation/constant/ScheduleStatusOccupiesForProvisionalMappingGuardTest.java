 ...
 * 시간 슬롯 충돌({@link ScheduleStatus#occupiesTimeForConflictCheck()})은 별도이며 COMPLETED를 포함한다.
 *
 * @author MindGarden
 * @since 2026-09-09
 */
...
class ScheduleStatusOccupiesForProvisionalMappingGuardTest {
    ...
    @Test
    @DisplayName("COMPLETED는 가예약 차단 아님·이력 표시·슬롯 충돌 점유")
    void completed_isHistoryNotProvisionalOccupy_butTimeConflict() {
