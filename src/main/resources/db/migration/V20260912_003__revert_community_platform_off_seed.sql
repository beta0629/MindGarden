-- =============================================================================
-- 교정: 구 V20260912_002 커뮤니티 전플랫폼 OFF 시드 철회 (이미 적용된 DB용)
-- SSOT: docs/project-management/MENU_VISIBILITY_IOS_REVIEW_ONE_BUTTON_ORCHESTRATION_20260912.md
--
-- 신규 설치는 개정된 V20260912_002만으로 충분(커뮤니티 OFF 시드 없음).
-- 본 스크립트는 구 002가 이미 실행된 DB에서 FLYWAY 시드 행만 ON으로 복구한다.
...
WHERE rmp.assigned_by LIKE 'FLYWAY_V20260912_002_COMMUNITY%';
